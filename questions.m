...
case 1
	...
	disp('  TYPHOON  Version 1 Test version          ')
    disp('  build 2019 5th of November                         ')
	disp('  Main Menu                                          ')
	disp('______________________________________________________')
   disp(' Input operations. ');
   disp('	[1]. Hydrofoil craft geometry setup ') %done
   disp('	[2]. Sailing condition setup ')%done
   disp('	[3]. Change rudder setting ')
   disp('	[4]. Move reference point ')
   disp(' ')
   disp(' Lattice operations. ');
   disp('	[5]. Generate lattice. ')%tocomplete
   disp('	     ')
...
case 2
   ...
   disp(' ')
   disp('	[1]. Define new geometry ')   %done
   disp('	[2]. Load geometry')
   disp('	[3]. Edit current geometry') %TODO
...
case 4
   ...
   disp('"                                                    ')
	disp('______________________________________________________')
	disp(' ')
	disp('	[1]. Define new state ')   %done
    disp('	[2]. Load state')
    disp('    [3]. Save current state')
    disp(' ')
    disp('    [4]. Change angle of attack') %TODO
	disp(' ')
	disp('	[0]. Back / up menu')
	disp(' ')
	output=input(' Please enter choice from above: ');
...
case(10)
 ...
 case(11)    
   ...
   disp('   [2]. Static equilibrium. ')
   disp('   [3]. Stabiliy matrix')
