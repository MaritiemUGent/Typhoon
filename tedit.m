         ...
         if isempty(choice1)
   		...
   		disp(' ')
	 		...
	 		switch choice1
				...
				geo.foiltheta(geo.nwing) = 0;
				geo.curved(geo.nwing,:)=0;
				geo.radius(geo.nwing,:)=0;
   			...
   			case 2
				...
				%new elements due to update
				geo.curved(choice3,i)=0;
				geo.curved(choice3,i)=0;
				geo.foiltheta(choice3)=0;
            ...
            case 6
   	   		...
   	   		while loop2==1
                    ...
                    disp('Global entries ')
                    disp(' ')
                    disp(strcat('[20] Reference point position      :',num2str(geo.ref_point)))
                    ...
                    disp(' ')
 					...
 					disp(strcat('[2] Apex coordinates           :',num2str([geo.startx(wedit) geo.starty(wedit) geo.startz(wedit) ])))
  					disp(strcat('[3] Base chord                 :',num2str(geo.c(wedit))))
   	   			    disp(' ')
   	   			    disp(strcat('[25] AoA of foil  :',num2str(geo.foiltheta(wedit))))
					
					disp(' Partition specific entries ')
   	   			    disp(' ')
					disp(strcat('[24] radius of partition		:',num2str(geo.radius(wedit,eedit))))
					...
					if isempty(edit2)
   					...
   					switch edit2
						...
						case 20
							geo.ref_point=input('ref position [x y z]: ');
						case 24
							geo.radius(wedit,eedit)=input('radius of curvature:  ' );
						case 25
							geo.foiltheta(wedit) = input ('AoA of complete foil [deg]: ')*pi/180;
                        case 0
      	      			loop2=0; 
      					otherwise
      		   			terror(9)   
